...
import { ChartSpline, List, ListPlus, X, Save } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-black text-gray-100 flex flex-col relative">
      ...
      <div className="bg-black z-20 px-5 mb-4 mx-auto">
        <h2 className="text-2xl font-semibold text-white">Fund Detail</h2>
      </div>

      <div className='bg-gray-900 rounded-t-3xl'>
        {/* Fund Info + Add Button */}
        <div className="flex items-center justify-between px-5 py-5">
          <p className='text-lg font-semibold text-white'>January 2025 Fund</p>
          <button onClick={() => setShowModal(true)} className='bg-blue-600 p-1 rounded-md shadow-lg'>
        ...
        {/* Floating Add Button */}
        <button onClick={() => setShowModal(true)} className="fixed bottom-5 right-5 bg-blue-600 text-white p-4 rounded-2xl shadow-lg hover:scale-105">
          +
        </button>
